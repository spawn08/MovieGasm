...
public class DotProgressBar extends View {
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                setStartColor(
                        a.getInteger(
                                ...
                                ContextCompat.getColor(getContext(), R.color.sky_blue)
                        )
                );
                setEndColor(
                        a.getInteger(
                                R.styleable.DotProgressBar_endColor,
                                ContextCompat.getColor(getContext(), R.color.divider_light_grey)
                        )
                );
            ...
            setStartColor(ContextCompat.getColor(getContext(), R.color.sky_blue));
            setEndColor(ContextCompat.getColor(getContext(), R.color.divider_light_grey));
